...
import { Plus, Pencil, Trash2, Search, Tags, X, Loader2, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">Kategori Bahan</h1>
          <p className="text-gray-500 dark:text-dark-400 mt-1">Kelola kategori untuk mengelompokkan bahan baku</p>
        </div>
      ...
      {filteredCategories.length === 0 ? (
        <div className="card">
          <div className="empty-state py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Tidak ada kategori</h3>
            <p className="text-sm">
              {searchTerm ? 'Tidak ditemukan kategori dengan kata kunci tersebut' : 'Mulai dengan menambahkan kategori'}
            </p>
          </div>
        </div>
      ) : (
                  ...
                  <tr key={category.id}>
                    ...
                    <td>
                      <span className="badge badge-primary">
                        {category._count?.ingredients || 0} bahan
                      </span>
                    </td>
                    <td>
            ...
            {filteredCategories.map((category) => (
              <div key={category.id} className="card p-4">
                <div className="flex items-start gap-3 mb-3">
                  <div className="w-10 h-10 bg-primary-500/20 text-primary-400 rounded-lg flex items-center justify-center flex-shrink-0">
                    <Tags size={18} />
                  </div>
